...
async def fetch_place_ids(place: str):
    GOOGLE_MAPS_Search_Place_ENDPOINT = "https://places.googleapis.com/v1/places:searchText"
...
async def fetch_photo_ids(place_id: str):
    GOOGLE_MAPS_Place_Details_ENDPOINT = f"https://places.googleapis.com/v1/places/{place_id}?languageCode=en"
...
async def get_redirect_url(url: str):
    ...
    async with AsyncClient(follow_redirects=False) as client:
        ...
        if response.status_code in (301, 302, 303, 307, 308):
            ...
            return {"img_redirect_url": None, "message": "No redirect detected"}
