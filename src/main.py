...
from .routers import google_maps_router, openai_router, db_location_router, account_rounter, gemini_router
...
app.include_router(gemini_router.router, prefix="/v1/backend-api/gemini", tags=["Gemini"])
